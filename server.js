...
app.get('/home', function(req, res) {
	...
	db.any(query)
        ...
        .catch(function (err) {
            ...
            //req.flash('error', err);
	 //if this doesn't work for you replace with console.log
	    console.log(err);
            res.render('pages/home', {
                title: 'Home Page',
                data: '',
...
app.get('/player_info',  function(req, res) {
  ...
  // var query2 = 'SELECT * from football_players where ;';
  // var query3 = 'SELECT'
...
app.get('/player_info/select_player',  function(req, res) {
  ...
  console.log("The user entered " + playerID);
  var query1 = 'SELECT id, name from football_players;';
  var query2 = 'SELECT * from football_players where id=' + playerID +';';
  // var playerName = 'SELECT name from football_players where id=' + playerID +';';
  // console.log (playerName);
  var query3 = 'SELECT COUNT (*) from football_games WHERE ' + playerID +' = ANY(players);';
// var query3 = 'SELECT game_date, players from football_games WHERE ANY(players = 4);';
